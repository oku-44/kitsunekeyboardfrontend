									...
									<div className="group relative grid">
										...
										<p className='text-gray-500'>											
											<span className='sm:hidden'>
												{product.attributes.description.slice(0, 20)}...
											</span>
											<span className='hidden sm:block'>
												{product.attributes.description.slice(0, 60)}...
											</span>
										</p>
										{/* <p className='text-gray-500'>{product.attributes.description.length > 20 ? `${product.attributes.description.slice(0, 20)}...` : product.attributes.description}</p> */}
